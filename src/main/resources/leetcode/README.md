编号 | 题目 | 难易 | 类别 | 备注 | Y/N
--- | --- | --- | --- | --- | ---
1 | Two Sum | easy | K Sum | | Y
2 | Add Two Numbers | medium | 数学问题 |  | Y
...
11 | Container With Most Water | medium | 数组&链表 | | Y
12 | Integer to Roman | medium | | |
13 | Roman to Integer | easy | | |
14 | Longest Common Prefix | easy | 字符串 | | Y
15 | Three Sum | medium | K Sum | | Y
16 | Three Sum Closet | medium | K Sum | | Y
17 | Letter Combinations of a Phone Number | medium | | |
18 | Four Sum | medium | K Sum | TODO |
19 | Remove Nth Node From End of List | medium | 数组&链表 | √ | Y
20 | Valid Parentheses | easy | 栈&队列 | | Y
21 | Merge Two Sorted Lists | easy | 数组&链表 | √ | Y
22 | Generate Parentheses | medium | 深度优先 | | Y
